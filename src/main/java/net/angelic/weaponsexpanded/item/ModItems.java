...
public class ModItems {
    ...
    public static final Item WOODEN_WARHAMMER = registerItem("wooden_warhammer",
            settings -> new WarhammerItem(ToolMaterial.WOOD, 5.0F, -3.1F, 5.0F, -2.7F, settings));

    public static final Item GOLDEN_WARHAMMER = registerItem("golden_warhammer",
            settings -> new WarhammerItem(ToolMaterial.GOLD, 5.0F, -2.9F, 5.0F, -2.7F, settings));

    public static final Item STONE_WARHAMMER = registerItem("stone_warhammer",
            settings -> new WarhammerItem(ToolMaterial.STONE, 6.0F, -3.1F, 5.0F, -2.7F, settings));

    public static final Item IRON_WARHAMMER = registerItem("iron_warhammer",
            settings -> new WarhammerItem(ToolMaterial.IRON, 5.0F, -3.0F, 5.0F, -2.7F, settings));

    public static final Item DIAMOND_WARHAMMER = registerItem("diamond_warhammer",
            settings -> new WarhammerItem(ToolMaterial.DIAMOND, 4.0F, -2.9F, 5.0F, -2.7F, settings));

    public static final Item NETHERITE_WARHAMMER = registerItem("netherite_warhammer",
            settings -> new WarhammerItem(ToolMaterial.NETHERITE, 4.0F, -2.9F, 5.0F, -2.7F, settings.fireproof()));
