...
public class ModItems {
    ...
    public static final DeferredRegister.Items ITEMS =
            DeferredRegister.createItems(WeaponsExpanded.MODID);


    public static final DeferredItem<Item> WOODEN_BROADSWORD = registerItem("wooden_broadsword",
            setting -> new Item(setting.sword(ToolMaterial.WOOD, 2, -2.1f)));

    public static final DeferredItem<Item> GOLDEN_BROADSWORD = registerItem("golden_broadsword",
            setting -> new Item(setting.sword(ToolMaterial.GOLD, 2, -2.1f)));

    public static final DeferredItem<Item> STONE_BROADSWORD = registerItem("stone_broadsword",
            setting -> new Item(setting.sword(ToolMaterial.STONE, 2, -2.1F)));

    public static final DeferredItem<Item> COPPER_BROADSWORD = registerItem("copper_broadsword",
            setting -> new Item(setting.sword(ToolMaterial.COPPER, 2, -2.1F)));

    public static final DeferredItem<Item> IRON_BROADSWORD = registerItem("iron_broadsword",
            settings -> new Item(settings.sword(ToolMaterial.IRON, 2.0F, -2.2F)));

    public static final DeferredItem<Item> DIAMOND_BROADSWORD = registerItem("diamond_broadsword",
            settings -> new Item(settings.sword(ToolMaterial.DIAMOND, 2.0F, -2.2F)));

    public static final DeferredItem<Item> NETHERITE_BROADSWORD = registerItem("netherite_broadsword",
            settings -> new Item(settings.sword(ToolMaterial.NETHERITE, 2.0F, -2.2F).fireResistant()));

    public static final DeferredItem<Item> WOODEN_SICKLE = registerItem("wooden_sickle",
            settings -> new Item(settings.sword(ToolMaterial.WOOD, 2.5F, -2.3F)));

    public static final DeferredItem<Item> GOLDEN_SICKLE = registerItem("golden_sickle",
            settings -> new Item(settings.sword(ToolMaterial.GOLD, 2.5F, -2.3F)));

    public static final DeferredItem<Item> STONE_SICKLE = registerItem("stone_sickle",
            settings -> new Item(settings.sword(ToolMaterial.STONE, 2.5F, -2.3F)));

    public static final DeferredItem<Item> COPPER_SICKLE = registerItem("copper_sickle",
            settings -> new Item(settings.sword(ToolMaterial.COPPER, 2.5F, -2.3F)));

    public static final DeferredItem<Item> IRON_SICKLE = registerItem("iron_sickle",
            settings -> new Item(settings.sword(ToolMaterial.IRON, 2.5F, -2.3F)));

    public static final DeferredItem<Item> DIAMOND_SICKLE = registerItem("diamond_sickle",
            settings -> new Item(settings.sword(ToolMaterial.DIAMOND, 2.5F, -2.3F)));

    public static final DeferredItem<Item> NETHERITE_SICKLE = registerItem("netherite_sickle",
            settings -> new Item(settings.sword(ToolMaterial.NETHERITE, 2.5F, -2.3F).fireResistant()));

    public static final DeferredItem<Item> WOODEN_SCYTHE = registerItem("wooden_scythe",
            settings -> new Item(settings.sword(ToolMaterial.WOOD, 4.0F, -2.5F)));

    public static final DeferredItem<Item> GOLDEN_SCYTHE = registerItem("golden_scythe",
            settings -> new Item(settings.sword(ToolMaterial.GOLD, 4.0F, -2.5F)));

    public static final DeferredItem<Item> STONE_SCYTHE = registerItem("stone_scythe",
            settings -> new Item(settings.sword(ToolMaterial.STONE, 4.0F, -2.5F)));

    public static final DeferredItem<Item> COPPER_SCYTHE = registerItem("copper_scythe",
            settings -> new Item(settings.sword(ToolMaterial.COPPER, 4.0F, -2.5F)));

    public static final DeferredItem<Item> IRON_SCYTHE = registerItem("iron_scythe",
            settings -> new Item(settings.sword(ToolMaterial.IRON, 4.0F, -2.5F)));

    public static final DeferredItem<Item> DIAMOND_SCYTHE = registerItem("diamond_scythe",
            settings -> new Item(settings.sword(ToolMaterial.DIAMOND, 4.5F, -2.5F)));

    public static final DeferredItem<Item> NETHERITE_SCYTHE = registerItem("netherite_scythe",
            settings -> new Item(settings.sword(ToolMaterial.NETHERITE, 4.5F, -2.5F).fireResistant()));

    public static final DeferredItem<Item> WOODEN_LONGSWORD = registerItem("wooden_longsword",
            settings -> new BastardSwordItem(ToolMaterial.WOOD, 6.0F, -2.9F, 7.0F, -2.9F, settings));

    public static final DeferredItem<Item> GOLDEN_LONGSWORD = registerItem("golden_longsword",
            settings -> new BastardSwordItem(ToolMaterial.GOLD, 6.0F, -2.9F, 7.0F, -2.9F, settings));

    public static final DeferredItem<Item> STONE_LONGSWORD = registerItem("stone_longsword",
            settings -> new BastardSwordItem(ToolMaterial.STONE, 6.0F, -2.9F, 7.0F, -2.9F, settings));

    public static final DeferredItem<Item> COPPER_LONGSWORD = registerItem("copper_longsword",
            settings -> new BastardSwordItem(ToolMaterial.COPPER, 6.0F, -2.9F, 7.0F, -2.9F, settings));

    public static final DeferredItem<Item> IRON_LONGSWORD = registerItem("iron_longsword",
            settings -> new BastardSwordItem(ToolMaterial.IRON, 6.0F, -2.9F, 7.0F, -2.9F, settings));

    public static final DeferredItem<Item> DIAMOND_LONGSWORD = registerItem("diamond_longsword",
            settings -> new BastardSwordItem(ToolMaterial.DIAMOND, 6.0F, -2.9F, 7.0F, -2.9F, settings));

    public static final DeferredItem<Item> NETHERITE_LONGSWORD = registerItem("netherite_longsword",
            settings -> new BastardSwordItem(ToolMaterial.NETHERITE, 6.0F, -2.9F, 7.0F, -2.9F, settings.fireResistant()));

    public static final DeferredItem<Item> WOODEN_KATANA = registerItem("wooden_katana",
            settings -> new TwoHandedSwordItem(ToolMaterial.WOOD, 3.0F, -2.2F, settings));

    public static final DeferredItem<Item> GOLDEN_KATANA = registerItem("golden_katana",
            settings -> new TwoHandedSwordItem(ToolMaterial.GOLD, 3.0F, -2.2F, settings));

    public static final DeferredItem<Item> STONE_KATANA = registerItem("stone_katana",
            settings -> new TwoHandedSwordItem(ToolMaterial.STONE, 3.0F, -2.2F, settings));

    public static final DeferredItem<Item> COPPER_KATANA = registerItem("copper_katana",
            settings -> new TwoHandedSwordItem(ToolMaterial.COPPER, 3.0F, -2.2F, settings));

    public static final DeferredItem<Item> IRON_KATANA = registerItem("iron_katana",
            settings -> new TwoHandedSwordItem(ToolMaterial.IRON, 3.0F, -2.2F, settings));

    public static final DeferredItem<Item> DIAMOND_KATANA = registerItem("diamond_katana",
            settings -> new TwoHandedSwordItem(ToolMaterial.DIAMOND, 3.0F, -2.2F, settings));

    public static final DeferredItem<Item> NETHERITE_KATANA = registerItem("netherite_katana",
            settings -> new TwoHandedSwordItem(ToolMaterial.NETHERITE, 3.0F, -2.2F, settings.fireResistant()));

    public static final DeferredItem<Item> WOODEN_HATCHET = registerItem("wooden_hatchet",
            settings -> new AxeItem(ToolMaterial.WOOD, 5.0F, -3.0F, settings));

    public static final DeferredItem<Item> GOLDEN_HATCHET = registerItem("golden_hatchet",
            settings -> new AxeItem(ToolMaterial.GOLD, 5.0F, -2.8F, settings));

    public static final DeferredItem<Item> STONE_HATCHET = registerItem("stone_hatchet",
            settings -> new AxeItem(ToolMaterial.STONE, 6.0F, -3.0F, settings));

    public static final DeferredItem<Item> COPPER_HATCHET = registerItem("copper_hatchet",
            settings -> new AxeItem(ToolMaterial.COPPER, 6.0F, -3.0F, settings));

    public static final DeferredItem<Item> IRON_HATCHET = registerItem("iron_hatchet",
            settings -> new AxeItem(ToolMaterial.IRON, 5.0F, -2.9F, settings));

    public static final DeferredItem<Item> DIAMOND_HATCHET = registerItem("diamond_hatchet",
            settings -> new AxeItem(ToolMaterial.DIAMOND, 4.0F, -2.8F, settings));

    public static final DeferredItem<Item> NETHERITE_HATCHET = registerItem("netherite_hatchet",
    ...
    public static final DeferredItem<Item> WOODEN_BATTLEAXE = registerItem("wooden_battleaxe",
            settings -> new AxeItem(ToolMaterial.WOOD, 8.0F, -3.4F, settings));

    public static final DeferredItem<Item> GOLDEN_BATTLEAXE = registerItem("golden_battleaxe",
            settings -> new AxeItem(ToolMaterial.GOLD, 8.0F, -3.2F, settings));

    public static final DeferredItem<Item> STONE_BATTLEAXE = registerItem("stone_battleaxe",
            settings -> new AxeItem(ToolMaterial.STONE, 9.0F, -3.4F, settings));

    public static final DeferredItem<Item> COPPER_BATTLEAXE = registerItem("copper_battleaxe",
            settings -> new AxeItem(ToolMaterial.COPPER, 9.0F, -3.4F, settings));

    public static final DeferredItem<Item> IRON_BATTLEAXE = registerItem("iron_battleaxe",
            settings -> new AxeItem(ToolMaterial.IRON, 8.0F, -3.3F, settings));

    public static final DeferredItem<Item> DIAMOND_BATTLEAXE = registerItem("diamond_battleaxe",
            settings -> new AxeItem(ToolMaterial.DIAMOND, 7.0F, -3.2F, settings));

    public static final DeferredItem<Item> NETHERITE_BATTLEAXE = registerItem("netherite_battleaxe",
            settings -> new AxeItem(ToolMaterial.NETHERITE, 7.0F, -3.2F, settings.fireResistant()));

    public static final DeferredItem<Item> WOODEN_GREATSWORD = registerItem("wooden_greatsword",
            settings -> new TwoHandedSwordItem(ToolMaterial.WOOD, 8.0F, -3.3F, settings));

    public static final DeferredItem<Item> GOLDEN_GREATSWORD = registerItem("golden_greatsword",
            settings -> new TwoHandedSwordItem(ToolMaterial.GOLD, 8.0F, -3.1F, settings));

    public static final DeferredItem<Item> STONE_GREATSWORD = registerItem("stone_greatsword",
            settings -> new TwoHandedSwordItem(ToolMaterial.STONE, 8.0F, -3.3F, settings));

    public static final DeferredItem<Item> COPPER_GREATSWORD = registerItem("copper_greatsword",
            settings -> new TwoHandedSwordItem(ToolMaterial.COPPER, 8.0F, -3.3F, settings));

    public static final DeferredItem<Item> IRON_GREATSWORD = registerItem("iron_greatsword",
            settings -> new TwoHandedSwordItem(ToolMaterial.IRON, 8.0F, -3.2F, settings));

    public static final DeferredItem<Item> DIAMOND_GREATSWORD = registerItem("diamond_greatsword",
            settings -> new TwoHandedSwordItem(ToolMaterial.DIAMOND, 8.0F, -3.1F, settings));

    public static final DeferredItem<Item> NETHERITE_GREATSWORD = registerItem("netherite_greatsword",
            settings -> new TwoHandedSwordItem(ToolMaterial.NETHERITE, 8.0F, -3.1F, settings.fireResistant()));

    public static final DeferredItem<Item> WOODEN_WARHAMMER = registerItem("wooden_warhammer",
            settings -> new WarhammerItem(ToolMaterial.WOOD, 5.0F, -3.1F, 5.0F, -2.7F, "wooden_warhammer", settings));

    public static final DeferredItem<Item> GOLDEN_WARHAMMER = registerItem("golden_warhammer",
            settings -> new WarhammerItem(ToolMaterial.GOLD, 5.0F, -2.9F, 5.0F, -2.7F, "golden_warhammer", settings));

    public static final DeferredItem<Item> STONE_WARHAMMER = registerItem("stone_warhammer",
            settings -> new WarhammerItem(ToolMaterial.STONE, 6.0F, -3.1F, 5.0F, -2.7F, "stone_warhammer", settings));

    public static final DeferredItem<Item> COPPER_WARHAMMER = registerItem("copper_warhammer",
            settings -> new WarhammerItem(ToolMaterial.COPPER, 6.0F, -3.1F, 5.0F, -2.7F, "copper_warhammer",  settings));

    public static final DeferredItem<Item> IRON_WARHAMMER = registerItem("iron_warhammer",
            settings -> new WarhammerItem(ToolMaterial.IRON, 5.0F, -3.0F, 5.0F, -2.7F, "iron_warhammer", settings));

    public static final DeferredItem<Item> DIAMOND_WARHAMMER = registerItem("diamond_warhammer",
            settings -> new WarhammerItem(ToolMaterial.DIAMOND, 4.0F, -2.9F, 5.0F, -2.7F, "diamond_warhammer", settings));

    public static final DeferredItem<Item> NETHERITE_WARHAMMER = registerItem("netherite_warhammer",
            settings -> new WarhammerItem(ToolMaterial.NETHERITE, 4.0F, -2.9F, 5.0F, -2.7F, "netherite_warhammer", settings.fireResistant()));

    public static final DeferredItem<Item> HEAVY_ARROW = registerItem("heavy_arrow",
            settings -> new HeavyArrowItem(settings.stacksTo(64)));

    public static final DeferredItem<Item> EXPLOSIVE_ARROW = registerItem("explosive_arrow",
            settings -> new ExplosiveArrowItem(settings.stacksTo(64)));

    public static final DeferredItem<Item> LONGBOW = registerItem("longbow",
            settings -> new LongbowItem(settings.durability(384).enchantable(1)));

    public static final DeferredItem<Item> CHAIN_CROSSBOW = registerItem("chain_crossbow",
    ...
    private static ItemStack asStack(ItemLike itemLike) {
    ...
    private static void buildCreativeTabContents(BuildCreativeModeTabContentsEvent event) {
        ...
        ItemLike anchor = Items.WOODEN_SWORD;
