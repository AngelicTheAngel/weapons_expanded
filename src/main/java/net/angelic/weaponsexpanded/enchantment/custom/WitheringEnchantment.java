...
public class WitheringEnchantment extends Enchantment {
    ...
    public void doPostAttack(
        ...
        if (!user.level().isClientSide
            ...
            livingTarget.addEffect(new MobEffectInstance(MobEffects.WITHER, 40 + level * 60, 1));
            livingTarget.removeEffect(new MobEffectInstance(MobEffects.POISON).getEffect());
        }
    }
}